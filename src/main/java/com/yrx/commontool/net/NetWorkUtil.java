...
public class NetWorkUtil {
    ...
    private static String getMacFromCallCmd() {
        ...
        LogDebug.i(TAG, "cmd result : " + result);
...
//                ToastUtil.showMessage(context, "无法连接网络");
        ...
        try {
            ...
            if (IMSI == null) {
                if (TelephonyManager.SIM_STATE_READY == telephonyManager
                    ...
                    LogDebug.v(TAG, "getProvider.operator:" + operator);
                    if (operator != null) {
    ...
    /**
     * 获取网络类型
     * (注：指的是当前使用的网络类型，Ex:WIFI和4G同时打开，但WIFI不能上网时，会使用4G网络，则会返回NetworkType.Mobile)
     * @return
     */
